...
- 🎓 Estudante de Desenvolvimento de Software Multiplataforma na Fatec de Praia Grande
- 📚 Atualmente estou focado em aprender **Node.js** e **Java** durante o recesso
- 🧑‍💻 Experiência em **C#**, **SQL**, **JavaScript**, **HTML** e **CSS**
- 🚀 Buscando me tornar um desenvolvedor **Full Stack**
- 🎮 Apaixonado por games e tecnologia
- 🐍 Quero aprender **Python** em breve!
